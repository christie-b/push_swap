...
/*   Updated: 2021/08/12 12:25:40 by cboutier         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_sort(t_stack *stack_a, t_stack *stack_b)
{
	...
	else if (stack_a->capacity > 5 && stack_a->capacity <= 20)
		sort_twenty(stack_a, stack_b);
	else if (stack_a->capacity > 20 && stack_a->capacity <= 321)
...
*/
//CHECK IF WE SIMPLIFY BEFORE CHECKING FOR DUPS OR NOT